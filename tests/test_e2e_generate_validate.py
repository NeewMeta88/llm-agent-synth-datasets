...
def test_e2e_generate_validate_support(tmp_path: Path) -> None:
    input_path = Path("examples") / "example_input_raw_support.md"
...
def test_e2e_generate_validate_operator_quality(tmp_path: Path) -> None:
